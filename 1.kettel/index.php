...
<head>
	...
	<script type="text/javascript" src="../js/kettel.js"></script>
...
<body>
	<div class="wrapper">
		...
		<form action="transmitter.php" method="post" id="testform">
	<div class="id_container"><input type="text" class="textid" value="<?=$_GET['id']?>"></div>
			<div class="test">
				<?php $text= '1. Я хорошо понял инструкцию, которую только что прочитал: 
	...
	<div class="question"><?=$question?>
		...
		foreach ($answers as $aid => $answer) {
			...
			<div class="answers">
				...
				<input class="options" value="q<?=$qid?>a<?=$aid?>" type="radio" name="answeron<?=$qid?>" id="answers" required>
				<label class="answer" for="q<?=$qid?>a<?=$aid?>"><?=$answer?></label>
			</div>	<? ;
		} ?>
	</div>
	<?
...
<div class="control">
	...
	<input class="grow" type="reset" name="reset" id="res">
	<input class="grow" type="submit" name="submit" id="subm">
</div>
<input type="checkbox" class="qlength" name="qlength" checked value="<?=count($questions)?>">
</form>
